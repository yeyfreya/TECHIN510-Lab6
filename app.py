...
client = OpenAI(
    ...
    base_url=os.getenv("OPENAI_API_BASE_URL"), # Ensure this matches the .env variable name
)
...
if uploaded_file:
    ...
    if prompt := st.text_input("Enter your text for revision or ask a question about the uploaded document:"):
        ...
        st.session_state.submit = st.button('Submit')
